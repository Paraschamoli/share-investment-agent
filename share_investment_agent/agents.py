...
class InvestmentAnalysisAgent:
    ...
    async def run(self, **kwargs) -> str:
        ...
        try:
            ...
            logger.error(f"Error occurred in {self.role}: {e}")
    ...
    def _extract_thesis_points(self, analysis: str, perspective: str) -> List[str]:
        ...
        for line in lines:
            ...
            if line and not line.startswith('#') and len(line) > 10:
                # Add as thesis point if it contains relevant keywords
                if any(keyword in line.lower() for keyword in ['growth', 'profit', 'strong', 'good', 'positive', 'opportunity']):
                    thesis_points.append(line)
                elif any(keyword in line.lower() for keyword in ['risk', 'decline', 'weak', 'bad', 'negative', 'threat']):
                    thesis_points.append(line)
...
class MarketDataAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, analysis_request: str = "comprehensive analysis") -> Dict[str, Any]:
...
class TechnicalAnalysisAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, market_data: Dict[str, Any], analysis_request: str = "technical analysis") -> Dict[str, Any]:
        ...
        try:
            ...
            if not price_history or len(price_history) < 50:
                return {
                    "ticker": self.ticker,
                    "error": "Insufficient price history for technical analysis",
                    "timestamp": datetime.now().isoformat()
                }
...
class FundamentalAnalysisAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, market_data: Dict[str, Any], analysis_request: str = "fundamental analysis") -> Dict[str, Any]:
    ...
    def _analyze_growth(self, financial_data):
        ...
        growth_score = sum(
            metric is not None and metric > threshold
            for metric, threshold in growth_metrics
        ) / len(growth_metrics)
...
class SentimentAnalysisAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, news_data: Dict[str, Any], market_context: Dict[str, Any], analysis_request: str = "sentiment analysis") -> Dict[str, Any]:
...
class ValuationAnalysisAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, financial_data: Dict[str, Any], market_data: Dict[str, Any], analysis_request: str = "valuation analysis") -> Dict[str, Any]:
...
class PortfolioManagementAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, specialist_inputs: Dict[str, Any], portfolio_context: Dict[str, Any], analysis_request: str = "final investment decision") -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Portfolio management analysis failed: {e}")
            return {
                "ticker": self.ticker,
                "error": str(e),
                "timestamp": datetime.now().isoformat()
...
class RiskManagementAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, debate_results: Dict[str, Any], specialist_analyses: Dict[str, Any], analysis_request: str = "risk management analysis") -> Dict[str, Any]:
    ...
    def _extract_risk_level(self, analysis: str) -> str:
        ...
        analysis_lower = analysis.lower()
        if "high risk" in analysis_lower or "very high risk" in analysis_lower:
            return "high"
    ...
    def _extract_mitigation_strategies(self, analysis: str) -> List[str]:
        ...
        for line in lines:
            line = line.strip()
            if line and any(keyword in line.lower() for keyword in ['mitigate', 'reduce', 'hedge', 'protect', 'diversify']):
                strategies.append(line)
        
        return strategies[:5]  # Return top 5 strategies

    def _calculate_var_estimate(self, analysis: str) -> float:
        """Calculate VaR estimate from analysis."""
        # Simple VaR estimation - can be enhanced with proper calculations
...
class MacroAnalysisAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, market_data: Dict[str, Any], debate_results: Dict[str, Any], analysis_request: str = "macroeconomic analysis") -> Dict[str, Any]:
    ...
    def _extract_economic_outlook(self, analysis: str) -> str:
        ...
        analysis_lower = analysis.lower()
        if "positive outlook" in analysis_lower or "favorable outlook" in analysis_lower:
            return "positive"
        elif "negative outlook" in analysis_lower or "unfavorable outlook" in analysis_lower:
            return "negative"
        else:
            return "neutral"
    ...
    def _extract_policy_impact(self, analysis: str) -> str:
        ...
        analysis_lower = analysis.lower()
        if "supportive policy" in analysis_lower or "favorable policy" in analysis_lower:
            return "supportive"
        elif "restrictive policy" in analysis_lower or "tightening policy" in analysis_lower:
            return "restrictive"
        else:
            return "neutral"
    ...
    def _extract_market_cycle(self, analysis: str) -> str:
        ...
        analysis_lower = analysis.lower()
        if "bull market" in analysis_lower or "upward trend" in analysis_lower:
            return "bull"
        elif "bear market" in analysis_lower or "downward trend" in analysis_lower:
            return "bear"
        else:
            return "neutral"
    ...
    def _extract_macro_recommendation(self, analysis: str) -> str:
        ...
        analysis_lower = analysis.lower()
        if "macro buy" in analysis_lower or "macro favorable" in analysis_lower:
            return "bullish"
        elif "macro sell" in analysis_lower or "macro unfavorable" in analysis_lower:
            return "bearish"
        else:
            return "neutral"
...
class MacroNewsAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, market_data: Dict[str, Any], analysis_request: str = "macro news analysis") -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Macro news analysis failed: {e}")
            return {
                "ticker": self.ticker,
                "error": str(e),
                "timestamp": datetime.now().isoformat()
    ...
    def _extract_key_events(self, analysis: str) -> List[str]:
        ...
        for line in lines:
            line = line.strip()
            if line and any(keyword in line.lower() for keyword in ['announcement', 'release', 'policy', 'decision', 'report']):
                events.append(line)
...
class ResearcherBullAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, specialist_inputs: Dict[str, Any], analysis_request: str = "bullish research analysis") -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bullish research analysis failed: {e}")
            return {
                "ticker": self.ticker,
                "error": str(e),
                "timestamp": datetime.now().isoformat()
...
class ResearcherBearAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, specialist_inputs: Dict[str, Any], analysis_request: str = "bearish research analysis") -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bearish research analysis failed: {e}")
            return {
                "ticker": self.ticker,
                "error": str(e),
                "timestamp": datetime.now().isoformat()
...
class DebateRoomAgent(InvestmentAnalysisAgent):
    ...
    async def run(self, bull_thesis: Dict[str, Any], bear_thesis: Dict[str, Any], analysis_request: str = "debate room analysis") -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Debate room analysis failed: {e}")
            return {
                "ticker": self.ticker,
                "error": str(e),
                "timestamp": datetime.now().isoformat()
    ...
    def _count_quality_indicators(self, thesis_points):
        ...
        for point in thesis_points:
            ...
            if any(indicator in point_lower for indicator in [
                'evidence', 'data', 'metric', 'ratio', 'analysis', 'trend', 'growth',
                'risk', 'opportunity', 'strength', 'weakness', 'potential', 'outlook'
            ]):
    ...
    def _assess_debate_quality(self, debate_analysis):
        ...
        quality_indicators = [
            'balanced', 'comprehensive', 'detailed', 'thorough', 'well-reasoned',
            'logical', 'structured', 'analytical', 'objective', 'nuanced'
        ]
...
class MultidisciplinaryInvestmentTeam:
    ...
    async def run_comprehensive_analysis(self, analysis_request: str = "comprehensive investment analysis") -> Dict[str, Any]:
        ...
        try:
            ...
            market_data_result = await self.market_data_agent.run(analysis_request)
            ...
            technical_task = self.technical_agent.run(market_data, "technical analysis")
            fundamental_task = self.fundamental_agent.run(market_data, "fundamental analysis")
            ...
            valuation_task = self.valuation_agent.run(
                market_data.get("financial_data", {}), 
                market_data, 
                "valuation analysis"
            )
            # Macro news runs in parallel like A_Share
            macro_news_task = self.macro_news_agent.run(market_data, "macro news analysis")
            
            # Wait for all 5 parallel analyses
            technical_result, fundamental_result, sentiment_result, valuation_result, macro_news_result = await asyncio.gather(
                technical_task, fundamental_task, sentiment_task, valuation_task, macro_news_task, return_exceptions=True
            )
            ...
            specialist_inputs = {
                ...
                "fundamental_analysis": fundamental_result if not isinstance(fundamental_result, Exception) else {"error": str(fundamental_result)},
                "sentiment_analysis": sentiment_result if not isinstance(sentiment_result, Exception) else {"error": str(sentiment_result)},
                "valuation_analysis": valuation_result if not isinstance(valuation_result, Exception) else {"error": str(valuation_result)}
            }
            
            # Step 4: Bull and Bear Researcher Analysis (receives inputs from 4 core specialists)
            bull_task = self.researcher_bull_agent.run(specialist_inputs, "bullish research analysis")
            bear_task = self.researcher_bear_agent.run(specialist_inputs, "bearish research analysis")
            ...
            if not isinstance(bull_result, Exception) and not isinstance(bear_result, Exception):
                debate_result = await self.debate_room_agent.run(bull_result, bear_result, "debate room analysis")
            else:
            ...
            if not isinstance(debate_result, Exception):
                risk_management_result = await self.risk_manager_agent.run(debate_result, specialist_inputs, "risk management analysis")
            else:
            ...
            if not isinstance(debate_result, Exception):
                macro_analysis_result = await self.macro_analyst_agent.run(market_data, debate_result, "macroeconomic analysis")
            else:
            ...
            enhanced_specialist_inputs = {
                **specialist_inputs,
                "researcher_bull": bull_result if not isinstance(bull_result, Exception) else {"error": str(bull_result)},
                "researcher_bear": bear_result if not isinstance(bear_result, Exception) else {"error": str(bear_result)},
                "debate_room": debate_result if not isinstance(debate_result, Exception) else {"error": str(debate_result)},
                "risk_management": risk_management_result if not isinstance(risk_management_result, Exception) else {"error": str(risk_management_result)},
                "macro_analysis": macro_analysis_result if not isinstance(macro_analysis_result, Exception) else {"error": str(macro_analysis_result)},
                "macro_news": macro_news_result if not isinstance(macro_news_result, Exception) else {"error": str(macro_news_result)}
            }
            
            final_decision = await self.portfolio_agent.run(enhanced_specialist_inputs, portfolio_context, "final investment decision")
            ...
            comprehensive_analysis = {
                ...
                "macro_news": macro_news_result if not isinstance(macro_news_result, Exception) else {"error": str(macro_news_result)},
                "researcher_analyses": {
                    "bull_researcher": bull_result if not isinstance(bull_result, Exception) else {"error": str(bull_result)},
                    "bear_researcher": bear_result if not isinstance(bear_result, Exception) else {"error": str(bear_result)}
                },
                "debate_room": debate_result if not isinstance(debate_result, Exception) else {"error": str(debate_result)},
                "risk_management": risk_management_result if not isinstance(risk_management_result, Exception) else {"error": str(risk_management_result)},
                "macro_analysis": macro_analysis_result if not isinstance(macro_analysis_result, Exception) else {"error": str(macro_analysis_result)},
...
"""
        ...
        error_msg = f"Error during investment analysis: {str(e)}"
        logger.error(f"Error during investment analysis: {str(e)}")
        return error_msg
